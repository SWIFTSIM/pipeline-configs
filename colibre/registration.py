...
register_stellar_metallicities([30], solar_metal_mass_fraction)
register_stellar_to_halo_mass_ratios([30, 100])
...
register_stellar_magnitudes([30], {"r": 2})
register_snia_rates_per_stellar_mass([30, 100])
register_stellar_mass_selection_masks([30])
