...
register_stellar_metallicities([30, 50], solar_metal_mass_fraction)
register_stellar_to_halo_mass_ratios([30, 50, 100])
register_oxygen_to_hydrogen([30, 50])
register_cold_dense_gas_metallicity(
    [30, 50], solar_metal_mass_fraction, twelve_plus_log_OH_solar
)
register_iron_to_hydrogen([50], solar_fe_abundance)
register_magnesium_to_hydrogen([50], solar_mg_abundance)
register_star_mg_and_o_to_fe([50])
register_dust([30, 50])
register_neutral_gas_fractions([30, 50, 100])
register_species_fractions([50])
register_stellar_birth_density()
register_gas_fraction()
register_los_stellar_velocity_dispersion()
register_stellar_magnitudes([30, 50], BAND_COLUMNS)
register_snia_rates_per_stellar_mass([30, 50, 100])
register_stellar_mass_selection_masks([30, 50])
