...
for color, (snapshot, name) in enumerate(zip(data, names)):
    ...
    if z < 5:
        ...
        stars_SNII_v_kick_by_redshift = {
            "$z < 7$": stars_SNII_v_kick_last[stars_SNII_redshifts < 7],
            "$7 < z < 10$": stars_SNII_v_kick_last[
                np.logical_and(stars_SNII_redshifts > 7, stars_SNII_redshifts < 10)
            ],
            "$z > 10$": stars_SNII_v_kick_last[stars_SNII_redshifts > 10],
        }

        gas_SNII_v_kick_by_redshift = {
            "$z < 7$": gas_SNII_v_kick_last[gas_SNII_redshifts < 7],
            "$7 < z < 10$": gas_SNII_v_kick_last[
                np.logical_and(gas_SNII_redshifts > 7, gas_SNII_redshifts < 10)
            ],
            "$z > 10$": gas_SNII_v_kick_last[gas_SNII_redshifts > 10],
        }
