...
arguments = ScriptArgumentParser(
    description="Creates stellar mass-[Fe/H] relations using the log of mean."
)
...
ax.plot(stellar_mass,FeH_mean,'o',ms=2,label='COLIBRE')


bins = np.arange(6,10,0.2)
bins = 10**bins
xmedians = stats.binned_statistic(stellar_mass, stellar_mass, 'median', bins=bins)
ymedians = stats.binned_statistic(stellar_mass, FeH_mean, 'median', bins=bins)
