"""
Makes a histogram of the gas particles' number of received AGN feedback events.
"""
...
def make_single_image(filenames, names, N_bounds, number_of_simulations, output_path):
    ...
    ax.set_xlabel("Gas num. of AGN events received $N_{\\rm AGN}$ [-]")
    ax.set_ylabel("PDF [-]")
    ax.semilogy()
    ...
    fig.savefig(f"{output_path}/gas_num_AGN_events.png")
