...
def make_single_image(filenames, names, mass_bounds, value_bounds, number_of_simulations, output_path):
    ...
    ax.set_ylabel("Number Of Particles Kicked Into Black Hole Jets  $N_{\\rm jet}$")
    ax.set_xscale('log')
    ax.set_yscale('log')
    ...
    fig.savefig(f"{output_path}/black_hole_jet_kicks.png")
...
if __name__ == "__main__":
    ...
    arguments = ScriptArgumentParser(description="Number of particles kicked into jets by AGN jet feedback - BH mass relation")
