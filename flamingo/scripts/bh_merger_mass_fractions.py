...
def get_data(filename):
    ...
    values = 1.-np.array(data.black_holes.total_accreted_masses.value*10**10)/np.array(masses.value)
...
if __name__ == "__main__":
    ...
    arguments = ScriptArgumentParser(description="Merger Mass Fraction - BH mass relation")
