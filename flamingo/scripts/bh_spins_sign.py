...
def make_single_image(
    ...
    ax.set_ylabel(r"Fraction With Positive Spin")
    ax.set_xscale("log")
    ...
    fig.savefig(f"{output_path}/black_hole_spin_signs.png")
...
if __name__ == "__main__":
    ...
    arguments = ScriptArgumentParser(description="Spin sign - BH mass relation")
