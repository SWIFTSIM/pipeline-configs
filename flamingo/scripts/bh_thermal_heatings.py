...
def get_data(filename):
    ...
    values = np.array(data.black_holes.number_of_heating_events.value)

    return np.array(masses.value)[values>0.0000000001], values[values>0.0000000001]
...
if __name__ == "__main__":
    ...
    arguments = ScriptArgumentParser(description="Number of particles heated by AGN thermal feedback - BH mass relation")
